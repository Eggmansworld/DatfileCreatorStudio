...
{
    private static readonly IBrush HdrBrush = new ImmutableSolidColorBrush(Color.Parse("#4A9EDA"));
    ...
    private static readonly IBrush IssueBrush = new ImmutableSolidColorBrush(Color.Parse("#E8A33D"));
